...
- [readthefinance](readthefinance.com) | [5MinuteFinance.org](https://www.5minutefinance.org/)
...
Cases are due on the second 

```{r outline, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl2 <- "
| Week | Case |
| ---- | ---- |
| Weeks 1 and 2: 8/31--9/11 | Setting themes--Cases in module: **Ben & Jerry** |
| Weeks 3 and 4: 9/14--9/25 | **FedEx vs. UPS** |
| Weeks 5 and 6: 9/28--10/9 | Krispy Kreme  |
| Weeks 7 and 8: 10/12--10/23 | Securitization | ## The Body Shop |
| Weeks 9 and 10: 10/26--11/6 | Financial Analysis and Forecasting--Case: **Value-Line Publishing (HD vs LOW)** |
| Weeks 11 and 12: 11/9--11/20 | Estimating the cost of capital--Case: **Nike, Inc.** | 
